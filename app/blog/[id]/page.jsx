    ...
    <section className="container max-w-3xl">
      ...
      <div className="flex flex-col items-center justify-center">
        <Link href={`/user/${blogDetails?.authorId?._id.toString()}`}>
          <div className="flex flex-col justify-center items-center py-2">
            <Image 
              src={blogDetails?.authorId?.avatar?.url ? blogDetails?.authorId?.avatar?.url : demoImg}
              alt="avatar image"
              width={0}
              height={0}
              sizes="100vw"
        ...
        <div className="text-center space-y-3">
          ...
          <div>
            <Image 
              src={blogDetails?.image ? blogDetails?.image?.url : demoImg}
      ...
      <div>
        ...
        <div className="flex gap-3 py-5 items-center">
          ...
          <div>
            <p className="text-whiteColor">Jonah</p>
